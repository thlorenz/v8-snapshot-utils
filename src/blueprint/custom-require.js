...
function customRequire(modulePath, parent = {}) {
  // This injected function throws an error during the doctor step if the
  // module was deferred or declared norewrite. At runtime it is a noop.
  verifyModuleCanBeLoaded(modulePath)
